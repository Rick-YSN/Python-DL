...
train_writer = tf.summary.FileWriter(
    LOG_PATH + '/train_' + str(HIDDENLAYER_NODE) + '_' + str(BATCH_SIZE) + '_' + str(EPOCHS) + '_' + str(ETA),
    graph=tf.get_default_graph())
test_writer = tf.summary.FileWriter(
    LOG_PATH + '/test_' + str(HIDDENLAYER_NODE) + '_' + str(BATCH_SIZE) + '_' + str(EPOCHS) + '_' + str(ETA),
    graph=tf.get_default_graph())
